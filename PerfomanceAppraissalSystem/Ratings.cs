...
namespace PerfomanceAppraissalSystem
{
    public partial class Ratings : Form
    {
            ...
            if (cmbSelectRating.Text == "0/10")
            {
                if (cmbRatingPeriod.Text == "January-June")
                {
                    if (this.OpenConnection() == true)
                    {
                        try
                        {
                            String query = "INSERT INTO ratings (ratingsID, Rating, Period, Year, EmployeeID) VALUES('" + txtRatingID.Text + "', '" + cmbSelectRating.Text + "', '" + cmbRatingPeriod.Text + "', '" + txtYearRating.Text + "', '" + txtEmployeeID.Text + "')";
        ...
        private void cmdViewRating_Click(object sender, EventArgs e)
        {
           /* if ( txtRatingID.Text == "")
            {
                MessageBox.Show("Please, enter Rating ID for Rating to be viewed");
            }*/
            
            
               
                ViewRating();
                MessageBox.Show("Here are your ratings");
